...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			SellerFormController controller = loader.getController(); // Pegando o controlador da tela carregada na linha acima
			controller.setSeller(obj); // injetando o seller no controller
			controller.setServices(new SellerService(), new DepartmentService()); // injetando o SellerService no controller

...
public class Order implements Serializable {
	...
	// Associações com demais classes
	@ManyToOne
	@JoinColumn(name = "client_id")
	private User client; // ManytoOne - Relacionamento entre a classe Order e User para criação de PK no banco de dados
	...
	public Double getTotal() {	// Metodo get para retorno do total conforme diagrama da solução
		double sum = 0.0;

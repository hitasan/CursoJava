...
public class User implements Serializable {
	...
	private List<Order> orders = new ArrayList<>();	// Para coleção adicionamos somente o metodo get; OnetoMany - Relacionamento entre a classe Order e User para criação de PK no banco de dados
